...
// SignTimeoutRequest is a request to sign a Timeout (engram-sovereign-fsm's
// M0b f+1-quorum round-skip attestation, see tendermint.types.Timeout's doc).
type SignTimeoutRequest struct {
	Timeout *types.Timeout `protobuf:"bytes,1,opt,name=timeout,proto3" json:"timeout,omitempty"`
	ChainId string         `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
}

func (m *SignTimeoutRequest) Reset()         { *m = SignTimeoutRequest{} }
func (m *SignTimeoutRequest) String() string { return proto.CompactTextString(m) }
func (*SignTimeoutRequest) ProtoMessage()    {}
func (*SignTimeoutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb4e437a5328cf9c, []int{7}
}
func (m *SignTimeoutRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignTimeoutRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignTimeoutRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignTimeoutRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignTimeoutRequest.Merge(m, src)
}
func (m *SignTimeoutRequest) XXX_Size() int {
	return m.Size()
}
func (m *SignTimeoutRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SignTimeoutRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SignTimeoutRequest proto.InternalMessageInfo

func (m *SignTimeoutRequest) GetTimeout() *types.Timeout {
	if m != nil {
		return m.Timeout
	}
	return nil
...
func (m *SignTimeoutRequest) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
// SignedTimeoutResponse is a response containing a signed Timeout or an error.
type SignedTimeoutResponse struct {
	Timeout types.Timeout      `protobuf:"bytes,1,opt,name=timeout,proto3" json:"timeout"`
	Error   *RemoteSignerError `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (m *SignedTimeoutResponse) Reset()         { *m = SignedTimeoutResponse{} }
func (m *SignedTimeoutResponse) String() string { return proto.CompactTextString(m) }
func (*SignedTimeoutResponse) ProtoMessage()    {}
func (*SignedTimeoutResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb4e437a5328cf9c, []int{8}
}
func (m *SignedTimeoutResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignedTimeoutResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignedTimeoutResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignedTimeoutResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedTimeoutResponse.Merge(m, src)
}
func (m *SignedTimeoutResponse) XXX_Size() int {
	return m.Size()
}
func (m *SignedTimeoutResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SignedTimeoutResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SignedTimeoutResponse proto.InternalMessageInfo

func (m *SignedTimeoutResponse) GetTimeout() types.Timeout {
	if m != nil {
		return m.Timeout
	}
...
func (m *SignedTimeoutResponse) GetError() *RemoteSignerError {
	if m != nil {
		return m.Error
	}
	return nil
...
type Message struct {
	...
	//	*Message_SignTimeoutRequest
	//	*Message_SignedTimeoutResponse
...
type Message_SignTimeoutRequest struct {
	SignTimeoutRequest *SignTimeoutRequest `protobuf:"bytes,9,opt,name=sign_timeout_request,json=signTimeoutRequest,proto3,oneof" json:"sign_timeout_request,omitempty"`
}
type Message_SignedTimeoutResponse struct {
	SignedTimeoutResponse *SignedTimeoutResponse `protobuf:"bytes,10,opt,name=signed_timeout_response,json=signedTimeoutResponse,proto3,oneof" json:"signed_timeout_response,omitempty"`
}
...
func (*Message_SignTimeoutRequest) isMessage_Sum()     {}
func (*Message_SignedTimeoutResponse) isMessage_Sum()  {}
...
func (m *Message) GetSignTimeoutRequest() *SignTimeoutRequest {
	if x, ok := m.GetSum().(*Message_SignTimeoutRequest); ok {
		return x.SignTimeoutRequest
	}
	return nil
}

func (m *Message) GetSignedTimeoutResponse() *SignedTimeoutResponse {
	if x, ok := m.GetSum().(*Message_SignedTimeoutResponse); ok {
		return x.SignedTimeoutResponse
	}
	return nil
}
...
func (*Message) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Message_SignTimeoutRequest)(nil),
		(*Message_SignedTimeoutResponse)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*SignTimeoutRequest)(nil), "tendermint.privval.SignTimeoutRequest")
	proto.RegisterType((*SignedTimeoutResponse)(nil), "tendermint.privval.SignedTimeoutResponse")
...
var fileDescriptor_cb4e437a5328cf9c = []byte{
	...
	,
}
...
func (m *SignTimeoutRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignTimeoutRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignTimeoutRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SignedTimeoutResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignedTimeoutResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignedTimeoutResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Message_SignTimeoutRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignTimeoutRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignTimeoutRequest != nil {
		{
			size, err := m.SignTimeoutRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_SignedTimeoutResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignedTimeoutResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignedTimeoutResponse != nil {
		{
			size, err := m.SignedTimeoutResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignTimeoutRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SignedTimeoutResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_SignTimeoutRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignTimeoutRequest != nil {
		l = m.SignTimeoutRequest.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Message_SignedTimeoutResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignedTimeoutResponse != nil {
		l = m.SignedTimeoutResponse.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *SignTimeoutRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignTimeoutRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignTimeoutRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *SignedTimeoutResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignedTimeoutResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignedTimeoutResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignTimeoutRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignTimeoutRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignTimeoutRequest{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedTimeoutResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignedTimeoutResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignedTimeoutResponse{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
