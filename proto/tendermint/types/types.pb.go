...
// local-timer-driven round advance. Unlike Vote, it carries no BlockID or
// timestamp: a validator legitimately reporting a timeout for several
// different candidate rounds is not an equivocation/safety concern the way
// double-voting a block is, so signing it needs no HRS (height/round/step)
// double-sign protection (see privval/file.go's SignTimeout).
type Timeout struct {
	Height           int64  `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round            int32  `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	...
	// Timeout signature by the validator attesting to the (height, round) pair.
...
func (m *Timeout) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *Timeout) GetValidatorAddress() []byte {
	if m != nil {
		return m.ValidatorAddress
	}
	return nil
...
func (m *Timeout) GetValidatorIndex() int32 {
	if m != nil {
		return m.ValidatorIndex
	}
	return 0
...
func (m *Timeout) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Timeout)(nil), "tendermint.types.Timeout")
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
