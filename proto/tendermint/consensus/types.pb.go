...
// Timeout is broadcast when a validator's local round timer expires,
// enabling f+1-quorum round-skip (engram-sovereign-fsm's M0b: mirrors
// spec/core/EngramTendermint.tla's BroadcastTimeout/UponfPlusOneTimeoutsAny)
// instead of purely local-timer-driven round advancement. Wraps the signed
// tendermint.types.Timeout (like Vote/Proposal above wrap their core types)
// so recipients can verify it against the validator set instead of trusting
// the sending peer's raw p2p identity -- see consensus/state.go's
// handleTimeoutMessage for the verify-then-count quorum side.
type Timeout struct {
...
func (m *Timeout) GetTimeout() *types.Timeout {
	if m != nil {
		return m.Timeout
	}
	return nil
...
type Message_Timeout struct {
	Timeout *Timeout `protobuf:"bytes,10,opt,name=timeout,proto3,oneof" json:"timeout,omitempty"`
}
...
func (m *Message) GetTimeout() *Timeout {
...
func init() {
	...
	proto.RegisterType((*Timeout)(nil), "tendermint.consensus.Timeout")
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
