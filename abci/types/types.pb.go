...
type RequestPrepareProposal struct {
	...
	// round is the consensus round this proposal is being built for
	// (engram-sovereign-fsm's Phase 7 addition -- vanilla ABCI 2.0 does not
	// expose this; see consensus/state.go's CreateProposalBlock caller, which
	// threads cs.Round through). Needed so the app can apply round-dependent
	// tolerance widening (e.g. spec/core/EngramTendermint.tla's BTCTolerance)
	// instead of assuming round 0 always.
...
type RequestProcessProposal struct {
	...
	ProposerAddress []byte `protobuf:"bytes,8,opt,name=proposer_address,json=proposerAddress,proto3" json:"proposer_address,omitempty"`
	// round is the consensus round this proposal was built for -- see
	// RequestPrepareProposal.round's doc.
	Round int32 `protobuf:"varint,9,opt,name=round,proto3" json:"round,omitempty"`
}
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
